...
class Solution:
    def flipEquiv(self, root1: Optional[TreeNode], root2: Optional[TreeNode]) -> bool:
        ...
        # Never touch root2, only try to make root1 equal to root2. I.e. pick a
        # tree to modify, and stick to that decision til the end.
        ...
        case2 = self.flipEquiv(root1.right, root2.left) and self.flipEquiv(root1.left, root2.right)
        if case2:
            return True
