class Solution:
    ...
    def dp3D(self, s1_index, s2_index, s3_index):
        ...
        s1_letter = ";" if s1_index >= len(self.s1) else self.s1[s1_index]
        s2_letter = ";" if s2_index >= len(self.s2) else self.s2[s2_index]
